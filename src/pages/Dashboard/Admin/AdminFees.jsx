  ...
  const fetchFees = async () => {
    try {
      const response = await fetch(
        "https://school-backend-8rpa.onrender.com/admin/fees.php"
      );
...
//  Fetch Students
  ...
  const fetchStudents = async () => {
    try {
      const response = await fetch(
        "https://school-backend-8rpa.onrender.com/admin/feeStudents.php"
      );
...
const handleFeeSubmit = async () => {
  ...
  try {
    const response = await fetch(
      "https://school-backend-8rpa.onrender.com/admin/addFee.php",
      {
        method: "POST",
        headers: {
...
const handlePaymentSubmit = async () => {
  ...
  try {
    const response = await fetch(
      "https://school-backend-8rpa.onrender.com/admin/addFeePayment.php",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
const closePaymentModal = () => {
  ...
  const handlePaymentHistory = async (fee) => {
    try {
      const response = await fetch(
        `https://school-backend-8rpa.onrender.com/admin/feePayments.php?student_id=${fee.student_id}`
      );
  ...
  const url =
    `https://school-backend-8rpa.onrender.com/admin/paymentReceipt.php?payment_id=${paymentId}`;
