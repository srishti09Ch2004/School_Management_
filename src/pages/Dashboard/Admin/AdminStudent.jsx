...
//   // State variables for managing filters and layouts
...
//   // Filter Arrays
//   const academicYears = ["2026", "2025", "2024", "2023"];
//   const months = [
...
//   const stats = [
//     { title: "Total Students", value: "2,540", icon: <Users size={18} />, color: "bg-blue-100 text-blue-600" },
//     { title: "Active Students", value: "2,410", icon: <UserCheck size={18} />, color: "bg-green-100 text-green-600" },
//     { title: "New Admissions", value: "130", icon: <UserPlus size={18} />, color: "bg-orange-100 text-orange-600" },
//   ];

//   // Extended schema with Parent Data and Timestamps
//   const students = [
//     {
//       id: 1,
//       name: "Rahul Sharma",
...
//         {/* Dynamic Date & Academic Year Chronological Controls */}
...
//             >
//               {academicYears.map(year => <option key={year} value={year}>Session: {year}</option>)}
//             </select>
//           </div>
...
//             Active Batch Count: {students.length}
//           </span>
//         </div>
...
//         {/* Scalable Layout Control Footer (Pagination View) */}
...
//             Showing <span className="font-medium text-gray-700">1</span> to <span className="font-medium text-gray-700">3</span> of <span className="font-medium text-gray-700">2,540</span> profiles
//           </p>
//           <div className="flex items-center gap-2">
//             <button className="p-2 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition disabled:opacity-50" disabled>
//               <ChevronLeft size={16} />
//             </button>
//             <button className="px-3.5 py-1.5 rounded-xl text-sm font-medium bg-green-600 text-white shadow-sm">1</button>
//             <button className="px-3.5 py-1.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition">2</button>
//             <button className="px-3.5 py-1.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition">3</button>
//             <button className="p-2 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition">
...
//             {/* Header Metadata Info inside Modal */}
